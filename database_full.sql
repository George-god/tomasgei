-- Cultivation RPG — full database (core + bloodlines + caves + artifacts).
-- New environment: mysql -u... -p... < database_full.sql
-- Split legacy snippets: sql/archive/
...
-- =============================================================================
-- EXTENSION MODULES: bloodlines (incl. abilities/evolution), caves, artifacts
-- =============================================================================
...
(3, 'war_buddha', 'War Buddha Heritage', 'Countless duels refined your intent into an immovable fighting spirit.',
    ...
    'none', 0.0000, 'Pure combat lineageâ€”bonuses focus on attack and breakthrough poise.', 5, 3),
...
(1, 'vermilion_fork', 'Vermilion Fork', 'Your meridians branch into a crimson latticeâ€”raw intensity, imperfect control.', 0.0450, 1),
...
(4, 'void_humor', 'Void Humor', 'An emptiness mixes with your bloodâ€”not hunger, but quiet subtraction.', 0.0350, 4),
...
(4, 3, 1.0650, 'The maze exhausts open warfareâ€”footing fails, openings widen.'),
...
(3, 'tide_lantern', 'Tideglass Lantern', 'Catches wandering spirits of sea-mist; steadies meridians.', 'rare',
    ...
    'Mist Shelter', 'A soft field misreads enemy timingâ€”minor dodge and trickle sustain.',
    15, 45, NULL, 0, 3),
(4, 'void_compass', 'Void-Bronze Compass', 'Needle does not point northâ€”it points toward pressure.', 'legendary',
    1, 0, 1, 1, 5,
