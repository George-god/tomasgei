...
require_once dirname(__DIR__) . '/services/PvEBattleService.php';
                ...
                <?php foreach ($npcs as $npc): ?>
                    <div class="bg-gray-900/80 border border-gray-700 rounded-lg p-4">
                        ...
                        <label class="flex items-center gap-2 text-xs text-gray-300 mt-4">
                            <input type="checkbox" class="pve-technique-toggle rounded border-gray-600 bg-gray-900 text-amber-500 focus:ring-amber-500" checked>
                            Auto-use Dao techniques
                        </label>
